...
module.exports = {
    ...
    output: [
        { // 打包umd格式文件
            file: path.resolve(__dirname, './dist/vconsole.umd.js'), // 输出路劲
            format: 'umd', // umd - 统一兼容模式 cjs - commonJs模式 ejs - es6模式
            name: 'Vconsole', // 对外暴露的顶级变量
            sourcemap: true // 开启sorcemap
        },
        { // 打包es格式文件
            file: path.resolve(__dirname, './dist/vconsole.es.js'), // 输出路劲
            format: 'es', // umd - 统一兼容模式 cjs - commonJs模式 ejs - es6模式
            name: 'Vconsole', // 对外暴露的顶级变量
            sourcemap: true // 开启sorcemap
        },
        { // 打包es格式文件
            file: path.resolve(__dirname, './dist/vconsole.common.js'), // 输出路劲
